-- Fixed Resources Tables Migration
...
INSERT IGNORE INTO resource_categories (id, name, description, icon, sort_order) VALUES
('cat-psico-001', 'Psicoeducación', 'Material educativo para pacientes', 'academic-cap', 1),
('cat-tareas-001', 'Tareas Terapéuticas', 'Ejercicios y actividades para terapia', 'clipboard-list', 2),
('cat-consent-001', 'Consentimientos', 'Formularios de consentimiento informado', 'shield-check', 3),
('cat-eval-001', 'Evaluaciones', 'Instrumentos de evaluación y escalas', 'chart-bar', 4),
('cat-guides-001', 'Guías de Tratamiento', 'Protocolos y guías clínicas', 'book-open', 5),
('cat-support-001', 'Material de Apoyo', 'Recursos complementarios', 'support', 6);

-- Insert default watermark template
INSERT IGNORE INTO watermark_templates (id, user_id, name, type, text_content, position, opacity, is_default) 
VALUES ('wm-default-001', 'system', 'MindHub Public Library', 'text', 'Hecho y distribuido por MindHub. Derechos reservados', 'bottom-center', 0.3, TRUE);