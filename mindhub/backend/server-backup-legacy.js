...
const formxRoutes = require('./formx/routes/main-formx-routes');
...
// === DEBUG ENDPOINTS FOR CLERK TROUBLESHOOTING ===
...
console.log('🔧 Debug endpoints enabled: /debug/clerk-env, /debug/verify-token');
