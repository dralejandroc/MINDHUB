...
export async function middleware(req: NextRequest) {
  ...
  res.headers.set('Content-Security-Policy', 
    ...
    "connect-src 'self' https://*.supabase.co https://jvbcpldzoyicefdtnwkd.supabase.co https://mindhub.cloud https://www.mindhub.cloud https://mindhub-django-backend.vercel.app http://localhost:* ws://localhost:*; " +
