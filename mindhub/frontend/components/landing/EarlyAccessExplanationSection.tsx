...
export function EarlyAccessExplanationSection({ onEarlyAccessClick }: EarlyAccessExplanationSectionProps) {
  return (
    <section className="relative py-20 bg-gradient-to-br from-primary-50 via-secondary-50 to-primary-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 lg:p-12">
              <div className="space-y-6">
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
                  <p>
                    <strong className="text-gray-900">Glian nace de la experiencia real</strong> de profesionales 
                  ...
                  <p>
                    Creemos que la mejor tecnología se construye <strong className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600">junto con quienes la van a usar</strong>. 
                  ...
                  <p>
                    Tu feedback no solo mejora Glian, <strong className="text-gray-900">define su futuro</strong>. 
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="bg-gradient-to-r from-primary-600 via-secondary-600 to-primary-600 text-white px-8 py-4 rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 font-semibold text-lg shadow-lg hover:from-primary-700 hover:via-secondary-700 hover:to-primary-700"
                  >
            ...
            {/* Visual Element */}
            <div className="bg-gradient-to-br from-primary-50/80 to-secondary-50/80 p-8 lg:p-12 flex items-center">
              <div className="w-full">
                ...
                <div className="space-y-6">
                  <div className="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                    <div className="w-12 h-12 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                  ...
                  <div className="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                    <div className="w-12 h-12 bg-gradient-to-r from-secondary-500 to-primary-500 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
