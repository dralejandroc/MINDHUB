 ...
 * 
 * This component was the main application component before migration to 
 * the new unified architecture with UnifiedSidebar.
 * 
 * ❌ DO NOT USE THIS COMPONENT
 * ✅ Use /hubs page with UnifiedSidebar instead
 * 
 * This file is kept for reference only and should be removed in the future.
 * All functionality has been migrated to:
 * - /app/hubs/page.tsx (main dashboard)
 * - /components/layout/UnifiedSidebar.tsx (navigation)
 * - Individual hub pages in /app/hubs/[hub]/page.tsx
 */
...
type Section = 'dashboard' | 'expedix' | 'clinimetrix' | 'formx' | 'resources' | 'reports' | 'settings';
...
export const MainApp: React.FC = () => {
  ...
  const handleNavigation = (section: Section) => {
    ...
    } else if (section === 'clinimetrix') {
      router.push('/hubs/clinimetrix');
    } else if (section === 'formx') {
      router.push('/hubs/formx');
    } else if (section === 'resources') {
      router.push('/hubs/resources');
  ...
  const renderSidebar = () => (
    <aside className={`fixed inset-y-0 left-0 z-50 w-64 text-white transform ${
