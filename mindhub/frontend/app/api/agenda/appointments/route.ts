// Agenda appointments endpoint - Proxy to Django
...
export async function GET(request: Request) {
  try {
    console.log('[AGENDA APPOINTMENTS] Processing GET request');
    ...
    console.log('[AGENDA APPOINTMENTS] Successfully proxied request to Django');
...
export async function POST(request: Request) {
  try {
    console.log('[AGENDA APPOINTMENTS] Processing POST request');
    ...
    const data = await response.json();
    console.log('[AGENDA APPOINTMENTS] Successfully proxied POST to Django');
