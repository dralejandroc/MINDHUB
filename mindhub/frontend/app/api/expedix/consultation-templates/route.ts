...
const DEFAULT_TEMPLATES = [
  {
    ...
    fields_config: ['currentCondition', 'physicalExamination', 'diagnosis', 'medications'],
    is_default: true,
    is_active: true,
  ...
  },
  {
    ...
    fields_config: ['vitalSigns', 'currentCondition', 'physicalExamination', 'diagnosis', 'medications'],
    is_default: false,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  ...
  },
  {
    ...
    fields_config: ['currentCondition', 'diagnosis'],
    is_default: false,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    ...
    template_type: 'specialized',
    fields_config: ['currentCondition', 'vitalSigns', 'physicalExamination', 'diagnosis', 'medications'],
    is_default: false,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
