      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self' https://*.supabase.co https://mindhub.cloud https://mindhub-django-backend.vercel.app https://mindhub-backend.vercel.app https://*.vercel.app; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.supabase.co https://mindhub.cloud https://mindhub-django-backend.vercel.app https://mindhub-backend.vercel.app; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://*.supabase.co; connect-src 'self' https://*.supabase.co https://jvbcpldzoyicefdtnwkd.supabase.co https://mindhub.cloud https://www.mindhub.cloud https://mindhub-django-backend.vercel.app https://mindhub-backend.vercel.app https://*.vercel.app http://localhost:* ws://localhost:*; frame-src 'self' https://*.supabase.co https://mindhub-django-backend.vercel.app https://mindhub-backend.vercel.app; worker-src 'self' blob: 'unsafe-inline'"
          },
        ],
      },
      {
